...
const EditPost = () => {
    ...
    const [photo, setPhoto] = useState("");  // Track existing photo URL
    ...
    const fetchPost = async () => {
        try {
            ...
            setPhoto(res.data.photo);  // Save existing photo URL
    ...
    const handleUpdate = async (e) => {
        ...
        const post = {
            ...
            userId: user._id,
            categories: cats,
            photo // Use the existing photo URL if no new file is uploaded
        };
        ...
        if (file) {
            ...
            try {
                ...
                post.photo = imgUpload.data.url;  // Update the post with the new Cloudinary image URL
            } catch (err) {
                console.log(err);
            }
        }
    ...
    const deleteCategory = (i) => {
        ...
        updatedCats.splice(i, 1);  // Fix for deleting the correct category
        setCats(updatedCats);
    };
